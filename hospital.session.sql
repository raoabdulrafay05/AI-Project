...
CREATE TABLE IF NOT EXISTS Doctors (
    ...
    Email VARCHAR(100),
    DepartmentID INT,
    DoctorFee DECIMAL(10,2) NOT NULL DEFAULT 0.00,
    DoctorSalary DECIMAL(10,2) NOT NULL DEFAULT 0.00,
    FOREIGN KEY (DepartmentID) REFERENCES Departments(DepartmentID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS Tests (
    ...
    TestPrice DECIMAL(10,2) DEFAULT 0.00,
    FOREIGN KEY (PatientID) REFERENCES Patients(PatientID) ON DELETE CASCADE,
    FOREIGN KEY (DoctorID) REFERENCES Doctors(DoctorID) ON DELETE SET NULL
);
...
-- Doctors
INSERT INTO Doctors (FullName, Specialization, PhoneNo, Email, DepartmentID, DoctorFee, DoctorSalary) VALUES 
('Dr. Ahmed Khan', 'Cardiologist', '03001234567', 'ahmed.khan@hospital.pk', 1, 1500, 150000),
('Dr. Sarah Ali', 'Neurologist', '03111234567', 'sarah.ali@hospital.pk', 2, 2000, 180000),
('Dr. Bilal Hussain', 'Orthopedic Surgeon', '03221234567', 'bilal.hussain@hospital.pk', 3, 1800, 170000),
('Dr. Ayesha Malik', 'General Physician', '03331234567', 'ayesha.malik@hospital.pk', 4, 1000, 120000),
('Dr. Muhammad Usman', 'Pediatrician', '03451234567', 'usman.pediatrics@hospital.pk', 5, 1300, 140000);
...
-- Medical Records
INSERT INTO MedicalRecords (PatientID, DoctorID, Diagnosis, Prescription, Date, MedicineFee) VALUES 
(1, 1, 'High Blood Pressure', 'Losartan 50mg', '2024-04-10', 500),
(2, 2, 'Migraine', 'Sumatriptan 100mg', '2024-04-12', 300),
(3, 3, 'Fractured Arm', 'Ibuprofen 400mg', '2024-04-15', 700),
(4, 4, 'Fever & Weakness', 'Paracetamol 500mg', '2024-04-20', 250),
(5, 5, 'Childhood Asthma', 'Salbutamol Inhaler', '2024-04-25', 450);

-- Tests
INSERT INTO Tests (PatientID, DoctorID, TestType, TestResult, TestDate, TestPrice) VALUES 
(1, 1, 'Blood Pressure Test', 'High BP detected', '2024-04-10', 500),
(2, 2, 'MRI Scan', 'No abnormality detected', '2024-04-12', 8000),
(3, 3, 'X-ray', 'Fracture in left arm', '2024-04-15', 3000),
(4, 4, 'Blood Test', 'Normal', '2024-04-20', 1500),
(5, 5, 'Lung Function Test', 'Asthma detected', '2024-04-25', 4000);

-- Bills
INSERT INTO Bills (PatientID, Expenses, BillDate, PaymentStatus) VALUES
(1, 5000, '2024-04-10', 'Paid'),
(2, 7000, '2024-04-12', 'Pending'),
(3, 12000, '2024-04-15', 'Paid'),
(4, 4000, '2024-04-20', 'Cancelled'),
...
-- Pharmacy
INSERT INTO Pharmacy (MedicineName, Quantity, PricePerUnit, PatientID) VALUES
('Aspirin', 50, 10.50, 1),
('Paracetamol', 100, 5.75, 2),
('Amoxicillin', 30, 12.30, 3);
